...
export const routes: Routes = [
    ...
    // VIDEO
    {path: 'upload', canActivate: [roleGuard, jwtGuard], loadComponent: () => import('./video/pages/upload/upload.component').then(c => c.UploadComponent)},
    ...
    {path: 'videos', canActivate: [roleGuard, jwtGuard], loadComponent: () => import('./video/pages/videos/videos.component').then(c => c.VideosComponent)},
    {path: 'history', canActivate: [roleGuard, jwtGuard], loadComponent: () => import('./video/pages/history/history.component').then(c => c.HistoryComponent)},
